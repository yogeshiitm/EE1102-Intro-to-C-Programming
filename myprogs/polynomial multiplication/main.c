...
/*This C program is for multiplting 2 second order polynomial and getting the coefficients of the
resultant 4th order polynomial*/
#include <stdio.h>
int main()
{
...
n=b*r+c*q;
o=c*r;
/*Here we get the output coefficients of the 4th order polynomial obtained by the product of the
above 2 polynomials*/
